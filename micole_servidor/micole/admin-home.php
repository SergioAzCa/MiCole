                    ...
                    <div class="ui-container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel">
                                    <header class="panel-heading">
                                        Estados de pedidos (sobre <?= $num_pedidos;?> pedidos)
                                        <span class="tools pull-right">
                                            <a class="close-box fa fa-times" href="javascript:;"></a>
                                        </span>
                                    </header>
                                    <div class="panel-body">
                                        <div id="torta-estado-pedidos" style="height: 370px;"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="panel">
                                    <header class="panel-heading">
                                        Estados de mapas (sobre <?= $num_mapas;?> mapas)
                                        <span class="tools pull-right">
                                            <a class="close-box fa fa-times" href="javascript:;"></a>
                                        </span>
                                    </header>
                                    <div class="panel-body">
                                        <div id="torta-estado-mapas" style="height: 370px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel">
                                    <header class="panel-heading">
                                        Colores vendidos (sobre <?= $num_mapas;?> mapas)
                                        <span class="tools pull-right">
                                            <a class="close-box fa fa-times" href="javascript:;"></a>
                                        </span>
                                    </header>
                            ...
                            <div class="col-md-6">
                                <div class="panel">
                                    <header class="panel-heading">
                                        Tamaños vendidos (sobre <?= $num_mapas;?> mapas)
                                        <span class="tools pull-right">
                                            <a class="close-box fa fa-times" href="javascript:;"></a>
                                        </span>
                                    </header>
                                    <div class="panel-body">
                                        <div id="basic-Pie-Tamanyo" style="height: 370px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div id="rainfall-desc" style="height: 370px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div> -->
