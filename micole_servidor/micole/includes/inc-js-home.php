...
function devuelveMaxAlt(){
  var alt_mod = $("#panel-home-modalidades").height();
  var alt_alumnos = $("#panel-home-ult-alumnos").height();
  var alt_devuelve = 0;
  if(alt_mod>alt_alumnos){
    alt_devuelve=alt_mod;
  }else{
    alt_devuelve=alt_alumnos;
  }
  console.log("Modalidades: " + alt_mod + " - Modalidades: " + alt_alumnos);
  return alt_devuelve;
}
$(document).ready(function(){
  $("#panel-home-modalidades, #panel-home-ult-alumnos").css("min-height", devuelveMaxAlt());
});
    ...
    yAxis : [
        {
            type : 'category',
            show : false,
            /*data : ['Bachiller científico tecnológico en castellano','Educación Infantil general en	valenciano',
            'Bachiller Artes en castellano','Bachiller Artes en valenciano','Bachiller científico de la salud en inglés']*/
            data : [<?= vcGrafMod("nombreModalidad");?>]
        }
    ],
    series : [
        {
