...
var grupoCapasNuestras = L.layerGroup().addTo(map_alumno);

var marker1 = L.marker([44.64, 22.63]).addTo(grupoCapasNuestras);
var marker2 = L.marker([44.65, 22.63]).addTo(grupoCapasNuestras);
console.log(grupoCapasNuestras.getLayers());*/
...
$(document).ready(function(){
    ...
    /*$.ajax({
        ...
        success: function(response) {
            ...
            map_alumno.setView([jsonData[0]['latitud'], jsonData[0]['longitud']], 15);
            //CAPA BASE
    ...
    /*$("input[name='num_policia']").change(function(){
      ...
      //map_alumno.removeLayer(grupoCapas);
