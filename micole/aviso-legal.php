...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>Aviso-legal | Geomodel Cartografía S.C.</title>
    <?php include("includes/metas.php");?>
</head>
<body class="quitaPadd" style="background-color:#ddd;">
    <div class="container">
        ...
        <div class="row">
        	<div class="col-md-12">
            	<h2>AVISO LEGAL</h2>
                <p>
                	<strong>Denominación Social</strong>: Geomodel Cartografía & SIG S.C.P.<br/>
	                <strong>Nombre Comercial</strong>; Geomodel<br/>
                    <strong>Domicilio Social</strong>: Avda. Mayor Nº 101 - Puerta 3. Massamagrell (46130) VALENCIA.<br/>
                    <strong>Teléfono</strong>: <a href="tel: +34661378249">661378249</a><br/>
                    <strong>CIF / NIF</strong><br/>
                    <strong>e-Mail</strong>: <a href="mailto:info@geomodel.es">info@geomodel.es</a><br/>
                    <strong>Página web</strong>: <a href="http://www.geomodel.es" target="_blank">geomodel.es</a><br/>
                </p>
                <h3>OBJETO</h3>
                    ...
                    <h3>PROTECCION DE DATOS PERSONALES</h3>
    				...
    				<ul>                
                        <li>E-Mail: <a href="mailto:info@geomodel.es">info@geomodel.es</a></li>
                        <li>Correo Postal: Avda. Mayor Nº 101 - Puerta 3. Massamagrell (46130) VALENCIA.</li>
                    </ul>
                    ...
                    <h3>USO DE COOKIES Y DEL FICHERO DE ACTIVIDAD</h3>
